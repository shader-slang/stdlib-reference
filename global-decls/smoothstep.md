...
<pre>
<span class="code_type">T</span> <a href="/stdlib-reference/global-decls/smoothstep">smoothstep</a>&lt;<span class="code_type">T</span>&gt;(
    <span class="code_type">T</span> <span class='code_param'>min</span>,
    <span class="code_type">T</span> <span class='code_param'>max</span>,
...
<a href="/stdlib-reference/types/vector/index" class="code_type">vector</a>&lt;<span class="code_type">T</span>, N&gt; <a href="/stdlib-reference/global-decls/smoothstep">smoothstep</a>&lt;<span class="code_type">T</span>, N:<span class="code_keyword">int</span>&gt;(
    <a href="/stdlib-reference/types/vector/index" class="code_type">vector</a>&lt;<span class="code_type">T</span>, N&gt; <span class='code_param'>min</span>,
    <a href="/stdlib-reference/types/vector/index" class="code_type">vector</a>&lt;<span class="code_type">T</span>, N&gt; <span class='code_param'>max</span>,
...
<a href="/stdlib-reference/types/matrix/index" class="code_type">matrix</a>&lt;<a href="/stdlib-reference/types/matrix/T" class="code_type">T</a>, N, M&gt; <a href="/stdlib-reference/global-decls/smoothstep">smoothstep</a>&lt;<span class="code_type">T</span>, N:<span class="code_keyword">int</span>, M:<span class="code_keyword">int</span>&gt;(
...
#### max  : T {#decl-max}
#### x  : T {#decl-x}
#### min  : [vector](/stdlib-reference/types/vector/index)\<T, N\> {#decl-min}
#### max  : [vector](/stdlib-reference/types/vector/index)\<T, N\> {#decl-max}
