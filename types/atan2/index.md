...
### Conformance to IForwardDifferentiable\<atan2\<T, M, N\>\>
`<T, int N>` additionally conforms to `IForwardDifferentiable<atan2<T, M, N>>` when the following conditions are met:
