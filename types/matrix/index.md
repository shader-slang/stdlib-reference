...
####  <a id="decl-L"></a>L  : MatrixLayoutMode = MatrixLayoutMode\.Unknown
...
`matrix<T, int R, int C, MatrixLayoutMode L>` additionally conforms to `IDifferentiable` when the following conditions are met:
