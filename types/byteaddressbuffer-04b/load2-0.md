...
You can't access the output parameter <span class='code'><a href="/stdlib-reference/types/byteaddressbuffer-04b/load2-0#decl-status" class="code_param">status</a></span> directly; instead,
