...
Atomically computes the minimum of the stored value and the given value
...
<pre>
<span class="code_keyword">void</span> <a href="index.html" class="code_type">Atomic</a>&lt;<a href="index.html#typeparam-T" class="code_type">T</a>&gt;.<a href="reducemin-6.html">reduceMin</a>(
    <a href="index.html#typeparam-T" class="code_type">T</a> <a href="reducemin-6.html#decl-value" class="code_param">value</a>,
    <a href="../memoryorder-06/index.html" class="code_type">MemoryOrder</a> <a href="reducemin-6.html#decl-order" class="code_param">order</a>)
